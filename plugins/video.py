...
async def stream(client, m: Message):
    ...
    if not media and not ' ' in m.text:
        await msg.edit("❗ __Send Me An Video Name / Live Stream Link / YouTube Video Link / Reply To An Video To Start Video Streaming!__")
        ...
        if match:
            ...
            try:
                ...
                thumb = f"https://i.ytimg.com/vi/{lmao}/maxresdefault.jpg"
        ...
        try:
            ...
            await m.reply_photo(photo=thumb, caption=f"▶️ **Started [Video Streaming]({link}) In {m.chat.title} !**")
            await msg.delete()
        except Exception as e:
